...
const NewChat: React.FC<NewChatProps> = ({ onClose, onResults, onError }) => {
  ...
  return (
    <div
      ...
      style={{ fontFamily: "Montserrat",boxShadow: "0px 4px 15px 0px #BED8FF", }}
    >
      {/* Encabezado */}
      <div className="flex items-center gap-4 mb-3 pl-5 pr-3.5 py-[19px] border-b border-[#DFE4EA]">
        <Cerrar
          ...
          onClick={onClose}
        />
        <h2 className="text-[16px] font-medium text-[#000000]">Nuevo chat</h2>
      </div>

      {/* Buscador */}
      <div className="flex relative mt-1 pl-5 pr-3.5 ">
        <input
          type="text"
